...
static T_KEY_Device s_tKEY_Dev = {
	.Key_Init = bsp_InitKey,
	.PutKeyVal = bsp_PutKey,
	.GetKeyVal = bsp_GetKey,
	.GetKeyState = bsp_GetKeyState,
	.SetKeyParam = bsp_SetKeyParam,
	.ClearKey = bsp_ClearKey,
	.KeyScan = bsp_KeyScan
};
...
{
	_ptKEY_Model->Key_dev = &s_tKEY_Dev;
}
...
//		&& (GPIO_PORT_K3->PID & GPIO_PIN_K3) != 0)
//		return 1;
//	else 
//		return 0;
	if((GPIO_PORT_K1->PID & GPIO_PIN_K1) == 0)
		return 1;
	else
		return 0;
}
...
static void bsp_InitKeyHard(void)
{
	...
	RCC_EnableAPB2PeriphClk(RCC_APB2_PERIPH_AFIO, ENABLE);//复用PA15
...
//	GPIO_InitPeripheral(GPIO_PORT_K3, &GPIO_InitStructure);
}
