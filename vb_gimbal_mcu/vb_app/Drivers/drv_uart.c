...
static void tim01A_init(void)
{
    ...
    /* 复位定时器0 */
    TIMER0_DeInit(M4_TMR01, Tim0_ChannelA);
	/* 获取pclk1时钟频率 */
    ...
    stcTimerCfg.Tim0_CmpValue = (uint16_t)((stcClk_t.pclk1Freq/4/1000)*5 - 1);	//约5ms
#else
	/* 配置异步计数模式 */
