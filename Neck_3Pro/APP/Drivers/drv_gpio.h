...
#define BT_LED_ON			GPIO_ResetBits(GPIOB, GPIO_PIN_5)
#define BT_LED_OFF			GPIO_SetBits(GPIOB, GPIO_PIN_5)
...
#define GREEN_LED_ON		GPIO_ResetBits(GPIOB, GPIO_PIN_3)
#define GREEN_LED_OFF		GPIO_SetBits(GPIOB, GPIO_PIN_3)
