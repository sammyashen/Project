...
#define UART1_RX_BUF_SIZE           (8*1024)	
#define	UART1_DMA_RX_BUF_SIZE		(2*1024)	
#define	UART1_DMA_TX_BUF_SIZE		(2*1024)

#define UART6_TX_BUF_SIZE           (8*1024)	
#define UART6_RX_BUF_SIZE           (8*1024)	
#define	UART6_DMA_RX_BUF_SIZE		(2*1024)	
#define	UART6_DMA_TX_BUF_SIZE		(2*1024)
